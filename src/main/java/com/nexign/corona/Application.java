...
public class Application {
    public static ApplicationContext run(String packageToScan, Map<Class, Class> ifc2ImplClass) {
        ...
        // контексту нужен конфиг, т.к. теперь только контект определяет какую реализацию нужно создать, а фабрика только создаёт нужную реализацию
        ...
        */
        ...
        // контексту нужна фабрика, т.к. таперь только через контекст создаются объекты или получаем из кэша готовые
