...
/*
  ...
  До бесконечности, потому что, в будущем мы не знаем сколько может появиться реализаций ConsoleAnnouncer и PolismenImlp
 */
//@Deprecated
public class CoronaDesinfector {
     ...
     */
    // private Announcer announcer  = new ConsoleAnnouncer();  // (!) на самом деле здесь 3-ответственности(Responsibility): выбор имплементации, её создание и её настройка
    // private Polismen polismen = new PolismenImlp();         // (!) на самом деле тоже 3 Responsibility

    // вот так намного лучше, данный класс не знает какие объекты он получит, за это отвечает фабрика
    ...
    public void start(Room room) {
        ...
        announcer.announce("Начинаем дезинфекцию, все вон"); // сообщить всем присутствующим в комнате о начале дезинфекции и попросить всех всалить
